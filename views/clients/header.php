...
<head>
    ...
    <style>
        ...
        body {
            margin: auto;
            /* Set width to make the content wider */
            width: 100%; /* Full width for larger screen size */
        }
        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <nav>
                <ul class="nav">
                    ...
                    <form action="<?= ROOT_URL . '?ctl=search'?>" method="POST">
                        <li>
                            <div class="search-container">
                                <input type="text" class="form-control" placeholder="Tìm kiếm sản phẩm..." id="keyword">
                                <button type="button" id="btnSearch" class="btn btn-danger btndanger">Tìm kiếm</button>
                            </div>
                        </li>
                    </form>
